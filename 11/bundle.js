...
/*!***************************!*\
  !*** ./src/mock/point.js ***!
  \***************************/
/*! exports provided: OFFERS, TYPES, DESTINATIONS, generateDescription, destinationDescriptions, generatePoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    this._datepicker = {
      start: flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(
          this.getElement().querySelector(`input[name=event-start-time]`),
          {
            ...
            defaultDate: this._data.times.start.toDate(),
            maxDate: this._data.times.end.toDate(),
            enableTime: true,
          ...
          {
            dateFormat: `d/m/y H:i`,
            defaultDate: this._data.times.end.toDate(),
            minDate: this._data.times.start.toDate(),
            enableTime: true,
            // eslint-disable-next-line camelcase
            time_24hr: true,
            onChange: this._dateChangeHandler(false)
          }
      )
    };
  }
