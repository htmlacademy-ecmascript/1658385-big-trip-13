...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: SortType, FilterType, UpdateType, ActionType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _presenter_filters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/filters */ "./src/presenter/filters.js");
/* harmony import */ var _presenter_trip__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./presenter/trip */ "./src/presenter/trip.js");
/* harmony import */ var _model_filters__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/filters */ "./src/model/filters.js");
...
const filtersModel = new _model_filters__WEBPACK_IMPORTED_MODULE_3__["default"]();
const filtersPresenter = new _presenter_filters__WEBPACK_IMPORTED_MODULE_1__["default"](filtersModel, filtersContainerElement);

const tripPresenter = new _presenter_trip__WEBPACK_IMPORTED_MODULE_2__["default"](pointsModel, filtersModel, tripEventsElement, pointsListElement, tripInfoElement, menuContainerElement, newEventButton);
...
/*!***************************!*\
  !*** ./src/mock/point.js ***!
  \***************************/
/*! exports provided: generateId, OFFERS, TYPES, DESTINATIONS, generateDescription, destinationDescriptions, generatePoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "destinationDescriptions", function() { return destinationDescriptions; });
...
const START_DATE = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(getRandomInt(-3), `days`);
const DURATION_IN_DAYS = 6;
...
const destinationDescriptions = new Map();
...
class FiltersModel extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class PointsModel extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._points = [];
  }
...
class FiltersPresenter {
  ...
  init() {
    ...
    this._filtersElement = new _view_filters__WEBPACK_IMPORTED_MODULE_1__["default"](this._getFilters(), this._currentFilter);
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._filtersElement, prevFiltersElement);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevFiltersElement);
  }
  ...
  _handleFilterChange(newFilter) {
    ...
    this._filtersModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR, newFilter);
  }
...
/* harmony import */ var _view_point_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/point-editor */ "./src/view/point-editor.js");
...
class NewPointPresenter {
  ...
  init() {
    ...
    this._editPointComponent = new _view_point_editor__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._editPointComponent.setFormSubmitHandler(this._handleFormSubmit);
    this._editPointComponent.setDeleteClickHandler(this._handleCancelClick);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._pointsListElement, this._editPointComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
  ...
  destroy() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._editPointComponent);
    this._editPointComponent = null;
  ...
  _handleFormSubmit(point) {
    this._changeData(
        _const__WEBPACK_IMPORTED_MODULE_3__["ActionType"].ADD,
        _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
        Object.assign(
            {id: Object(_mock_point__WEBPACK_IMPORTED_MODULE_1__["generateId"])()},
            point
        )
    );
...
class PointPresenter {
  ...
  _handleFavoriteClick() {
    this._changeData(
        _const__WEBPACK_IMPORTED_MODULE_3__["ActionType"].UPDATE,
  ...
  _handleFormSubmit(point) {
    const updateType = (point.price !== this._point.price || !Object(_utils_time__WEBPACK_IMPORTED_MODULE_4__["isEqualTime"])(point.times.start, this._point.times.start || !Object(_utils_time__WEBPACK_IMPORTED_MODULE_4__["isEqualTime"])(point.times.end, this._point.times.end)) || point.destination !== this._point.destination || !Object(_utils_common__WEBPACK_IMPORTED_MODULE_5__["isEqualOffers"])(point.offers, this._point.offers)) ? _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR : _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].PATCH;
    this._changeData(_const__WEBPACK_IMPORTED_MODULE_3__["ActionType"].UPDATE, updateType, point);
    this._replaceFormToPoint();
  }

  _handleDeletePoint(point) {
    this._changeData(_const__WEBPACK_IMPORTED_MODULE_3__["ActionType"].DELETE, _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MAJOR, point);
  }
...
/* harmony import */ var _view_sorting__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/sorting */ "./src/view/sorting.js");
/* harmony import */ var _view_trip_info_cost__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/trip-info-cost */ "./src/view/trip-info-cost.js");
/* harmony import */ var _view_trip_info_main__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/trip-info-main */ "./src/view/trip-info-main.js");
/* harmony import */ var _view_no_points__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/no-points */ "./src/view/no-points.js");
...
/* harmony import */ var _utils_sort__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/sort */ "./src/utils/sort.js");
/* harmony import */ var _new_point__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./new-point */ "./src/presenter/new-point.js");
...
class TripPresenter {
  constructor(pointsModel, filtersModel, tripEventsElement, pointsListElement, tripInfoElement, menuContainerElement, newEventButton) {
    ...
    this._currentSortType = _const__WEBPACK_IMPORTED_MODULE_7__["SortType"].DAY;

    this._menuElement = new _view_menu__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._sortingElement = null;
    this._tripInfoMainElement = null;
    this._tripInfoCostElement = null;
    this._noPointsElement = new _view_no_points__WEBPACK_IMPORTED_MODULE_5__["default"]();
    ...
    this._newPointPresenter = new _new_point__WEBPACK_IMPORTED_MODULE_10__["default"](this._pointsListElement, this._handleViewAction, newEventButton);
  }
  ...
  _getPoints() {
    ...
    const filteredPoints = _utils_filter__WEBPACK_IMPORTED_MODULE_8__["filter"][filterName](points);

    switch (this._currentSortType) {
      case _const__WEBPACK_IMPORTED_MODULE_7__["SortType"].TIME:
        filteredPoints.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_9__["sortPointsByTime"]);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_7__["SortType"].PRICE:
        filteredPoints.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_9__["sortPointsByPrice"]);
        break;
      default:
        filteredPoints.sort(_utils_sort__WEBPACK_IMPORTED_MODULE_9__["sortPointsByDay"]);
    }
  ...
  createPoint() {
    this._filtersModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].MAJOR, _const__WEBPACK_IMPORTED_MODULE_7__["FilterType"].EVERYTHING);
  ...
  _handleViewAction(actionType, updateType, updatedPoint) {
    switch (actionType) {
      case _const__WEBPACK_IMPORTED_MODULE_7__["ActionType"].UPDATE:
        this._pointsModel.updatePoint(updateType, updatedPoint);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_7__["ActionType"].DELETE:
        this._pointsModel.deletePoint(updateType, updatedPoint);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_7__["ActionType"].ADD:
  ...
  _renderTripInfo() {
    ...
    this._tripInfoMainElement = new _view_trip_info_main__WEBPACK_IMPORTED_MODULE_4__["default"](route, dates);

    if (prevTripInfoMainElement === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripInfoElement, this._tripInfoMainElement);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._tripInfoMainElement, prevTripInfoMainElement);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevTripInfoMainElement);
    }

    const prevTripInfoCostElement = this._tripInfoCostElement;

    const cost = TripPresenter.calcTripCost(points);
    this._tripInfoCostElement = new _view_trip_info_cost__WEBPACK_IMPORTED_MODULE_3__["default"](cost);
    if (prevTripInfoCostElement === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripInfoElement, this._tripInfoCostElement);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._tripInfoCostElement, prevTripInfoCostElement);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevTripInfoCostElement);
    }
  }
  ...
  _renderSorting() {
    ...
    this._sortingElement = new _view_sorting__WEBPACK_IMPORTED_MODULE_2__["default"](this._currentSortType);
    this._sortingElement._setSortTypeChangeHandler(this._handleSortTypeChange);

    if (prevSortingElement === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._tripEventsElement, this._sortingElement, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._sortingElement, prevSortingElement);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevSortingElement);
  }
  ...
  _renderPoint(point) {
    const pointPresenter = new _point__WEBPACK_IMPORTED_MODULE_6__["default"](this._pointsListElement, this._handleViewAction, this._handleModeChange);
...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FUTURE]: (points) => points.filter((point) => point.times.start.diff() >= 0),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].PAST]: (points) => points.filter((point) => point.times.end.diff() <= 0)
};
...
/*!***************************!*\
  !*** ./src/utils/sort.js ***!
  \***************************/
/*! exports provided: sortPointsByDay, sortPointsByTime, sortPointsByPrice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***************************!*\
  !*** ./src/utils/time.js ***!
  \***************************/
/*! exports provided: getDuration, isEqualTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDuration", function() { return getDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEqualTime", function() { return isEqualTime; });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
...
const isEqualTime = (dateA, dateB) => {
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB, `m`);
};
...
const BLANK_POINT = {
  ...
  offers: [],
  times: {
    start: dayjs__WEBPACK_IMPORTED_MODULE_3___default()(),
    end: dayjs__WEBPACK_IMPORTED_MODULE_3___default()().add(1, `hour`)
  },
  isFavorite: false
};
  ...
  return `
    <fieldset class="event__type-group">
      <legend class="visually-hidden">Event type</legend>
        ${_mock_point__WEBPACK_IMPORTED_MODULE_0__["TYPES"].map((type) => `
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            ...
            <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value=${destination} list="destination-list-1" pattern="${_mock_point__WEBPACK_IMPORTED_MODULE_0__["DESTINATIONS"].join(`|`)}" title="Available destinations: ${_mock_point__WEBPACK_IMPORTED_MODULE_0__["DESTINATIONS"].join(`, `)}">
...
class EditPointView extends _smart__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  _setDatepickers() {
    ...
    this._datepicker = {
      start: flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(
          this.getElement().querySelector(`input[name=event-start-time]`),
          makeDatePickerConfig(this._data.times.start.toDate(), this._data.times.end.toDate(), `maxDate`, true)
      ),
      end: flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(
  ...
  _dateChangeHandler(isStart) {
    return ([userDate]) => {
      this.updateData({
        times: {
          start: isStart ? dayjs__WEBPACK_IMPORTED_MODULE_3___default()(userDate) : this._data.times.start,
          end: isStart ? this._data.times.end : dayjs__WEBPACK_IMPORTED_MODULE_3___default()(userDate)
        }
      });
    };
  }
  ...
  _destinationChoiceHandler(evt) {
    if (_mock_point__WEBPACK_IMPORTED_MODULE_0__["DESTINATIONS"].includes(evt.target.value)) {
      this.updateData(
          Object.assign(
              {
  ...
  static getDescFields(destination) {
    const description = _mock_point__WEBPACK_IMPORTED_MODULE_0__["destinationDescriptions"].get(destination);
  ...
  static getAvailableOffers(type) {
    return _mock_point__WEBPACK_IMPORTED_MODULE_0__["OFFERS"].slice().filter((offer) => offer.type === type);
  }
  ...
  static parseDataToPoint(data) {
    ...
    point.offers = _mock_point__WEBPACK_IMPORTED_MODULE_0__["OFFERS"].filter((offer) => data.pickedOffers.has(offer.name));
  ...
  return `
    <form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      <div class="trip-sort__item  trip-sort__item--day">
        <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DAY ? `checked` : ``}>
      ...
      <div class="trip-sort__item  trip-sort__item--time">
        <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME ? `checked` : ``}>
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE ? `checked` : ``}>
